...
public class MainActivity extends AppCompatActivity
    ...
    public void irParaexame(View view) {
        Intent intent = new Intent(getApplicationContext(),exame.class);
        startActivity(intent);
    }

    public void irparaIntercorrencia(View view) {
    ...
    public void irparaDados(View view) {
        //Intent intent = new Intent(getApplicationContext(),);
    }

    public void irparaCatalog(View view) {
        //Intent intent = new Intent(getApplicationContext(),);
    }
}
